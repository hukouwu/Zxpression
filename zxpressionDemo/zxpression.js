...
function Zxpression(str, pa) {
	...
	// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
	var pri = {"||":[10,1,1],"&&":[10,1,1],"&":[13,1,1],"^":[13,1,1],"|":[13,1,1],"~":[50,0,1],"==":[20,1,1],"===":[20,1,1],"!==":[20,1,1],">":[20,1,1],">=":[20,1,1],"<":[20,1,1],"<=":[20,1,1],"<<":[21,1,1],">>":[21,1,1],">>>":[21,1,1],"+":[30,1,1],"-":[30,1,1],"*":[40,1,1],"/":[40,1,1],"%":[40,1,1],"!":[50,0,1],"-(S)":[51,0,1],"+(S)":[51,0,1],"--(B)":[51,0,1],"++(B)":[51,0,1],"--":[51,1,0],"++":[51,1,0],".":[52,1,1]};
	// 临时方案
	var buPri = ["["];
	// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
	var p;
